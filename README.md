...
统一测试任务：**煮沸水钙镁建模题**（质量守恒 + 沉淀 + 蒸发 + 冷却回溶，纯推理不调工具），全部 reasoningEffort=max。

### 思考链词汇对比

| 组合 | 思考字符 | Let me | We | Let's | /千字 |
|---|---|---|---|---|---|
| **Anchored Pro（本 preset）** | 91,692 | **13** | 6 | **131** | 0.14 |
| **Anchored Pro Deep** | 129,376 | 127 | 3 | 26 | 0.98 |
| 极简官方 pro | 122,928 | **7** | 4 | **153** | 0.06 |
| 标准官方 pro | 71,097 | 49 | 1 | 1 | 0.69 |
| 标准 opencode pro | 67,545 | 46 | 1 | 4 | 0.68 |
| 标准 opencode flash | 121,509 | 97 | 2 | 1 | 0.80 |
| Router Flash（切断） | 110,823 | 85 | 0 | 1 | 0.77 |
| Router Flash（未切断） | 245,011 | 154 | 0 | 4 | 0.63 |
| **Router Flash Deep** | 105,387 | 83 | 0 | 1 | 0.79 |

### 建模水平评分（六维加权，百分制）

| 排名 | 组合 | 正确(28) | 严谨(24) | 效率(14) | 语域(10) | 深度(14) | 结构(10) | 总分 |
|---|---|---|---|---|---|---|---|---|
| #1 | **Anchored Pro Deep** | 28 | 24 | 11 | 5 | 14 | 10 | **92** |
| #1 | 极简官方 pro | 27 | 23 | 12 | 9 | 11 | 10 | **92** |
| #3 | **Router Flash Deep** | 28 | 24 | 11 | 6 | 13 | 9 | **91** |
| #4 | **Anchored Pro** | 28 | 24 | 12 | 9 | 8 | 8 | **89** |
| #5 | 标准官方 pro | 27 | 23 | 13 | 6 | 10 | 8 | 87 |
| #6 | Router Flash 未切断 | 28 | 24 | 8 | 4 | 13 | 9 | 86 |
| #7 | 标准 opencode pro | 27 | 22 | 14 | 5 | 9 | 8 | 85 |
| #8 | Router Flash 切断 | 26 | 22 | 11 | 7 | 7 | 8 | 81 |
| #9 | 标准 opencode flash | 26 | 22 | 9 | 6 | 8 | 8 | 79 |

### 编程能力实测（Codeforces 难题）

| 题目 | 难度 | Anchored Pro（标准） | Anchored Pro Deep |
|---|---|---|---|
| CF 1842E Tenzing and Triangle | 2800 | ✅ 独立解出（样例+500对拍全过） | ✅ 独立解出（样例+300对拍全过） |
| CF 1778E The Tree Has Fallen! | 2900 | ✅ 独立解出（线性基+换根，0.05s） | ✅ 独立解出（可持久化线性基，28min） |

### 结论

- **Anchored Pro**（标准）：满血语域（we/let's）+ 高效率，日常首选；
- **Anchored Pro Deep**：极限深度（建模并列第一），适合复杂建模/长分析，代价是思考链 let me 密度高（不影响输出质量）；
- **回灌切断**是 opencode-go 语域干净的关键（实测 let me 减半以上）。
